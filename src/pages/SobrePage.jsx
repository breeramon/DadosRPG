...
//
// As 5 seções viraram um Accordion (React Bits, ver
// components/effects/Accordion.jsx) -- é bastante texto de referência,
// então começam todas recolhidas menos a primeira, em vez de jogar tudo
// numa rolagem só.
//
...
import Accordion from '@/components/effects/Accordion';
...
export default function SobrePage() {
    ...
    const secoes = [
        ...
        {
            id: 'extensoes',
            titulo: 'Extensões não-oficiais (regras de casa)',
            conteudo: (
                <>
    ...
    return (
        <div className="screen screen-sobre">
            <div className="sobre-panel">
                ...
                <Accordion items={secoes} abertosPadrao={['cobre']} />
            </div>
        </div>
    );
}

...
// origens.js
//
// Catálogo das Origens oficiais de Ordem Paranormal — a "profissão
// anterior" do personagem antes de entrar pra Ordo Realitas. Cada
// Origem concede 2 Perícias Treinadas fixas e um "Poder de Origem"
// único (habilidade especial que só quem tem aquela Origem possui).
//
// CONFIANÇA DOS DADOS (mesmo espírito de itens.js/rituais.js — pesquisa
// cuidadosa, já que o livro físico não está disponível de forma aberta
// pra conferência 100% garantida):
//   - Fonte principal: repositório GitHub SouOWendel/ordemparanormal_fvtt
//     (sistema de Foundry VTT open-source), lido direto (JSON puro via
//     raw.githubusercontent.com, sem resumo/IA no meio) na pasta
//     `packs/_source/origins/livro-de-regras/` — nome da pasta já
//     indica que é conteúdo do livro básico, separado de outras pastas
//     do mesmo repo pra sourcebooks diferentes (Arquivos Secretos,
//     Sobrevivendo ao Horror).
//   - As 16 primeiras (ORIGENS_CONFIANCA_ALTA abaixo) batem com a
//     lista "clássica" mais conhecida de Ordem Paranormal E foram
//     conferidas contra um resumo (Studocu "Livro de Regras
//     Resumido") que reproduziu várias delas palavra por palavra
//     (inclusive um detalhe bem específico, tipo o "DT 10" do
//     Amnésico) — confiança alta (🟢).
//   - As 10 seguintes (Agente de Saúde até Universitário) aparecem
//     consistentemente no mesmo repositório e num compêndio fã
//     separado que distingue "oficial" de "homebrew" — parecem ser
//     adições/errata oficial posterior do próprio livro básico, mas eu
//     não consegui confirmar em qual tiragem/errata exatamente elas
//     foram incluídas — confiança média (🟡): os nomes/perícias/poderes
//     provavelmente estão certos, mas vale conferir contra o livro
//     físico da sua mesa se notar alguma diferença.
//   - Duas fontes descartadas de propósito por inventarem conteúdo
//     contraditório a cada tentativa de leitura (nomes como "Abastado",
//     "Detetive", "Exorcista" que NÃO aparecem em nenhuma outra fonte
